...
const AdminSignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const user = await register({ full_name: fullName, email, password, role: 'hospital_admin' });
            // After successful admin registration, navigate to admin dashboard or admin users page
        ...
        <div className="min-h-screen pt-32 pb-20 px-8 bg-[#E2E8F0] flex justify-center items-center">
            <div className="w-full max-w-md bg-white p-10 rounded-[2.5rem] premium-shadow border border-white">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-gray-900">Admin Sign Up</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                        {loading ? 'Processing...' : 'Create Admin Account'} <ArrowRight size={18} />
                    </button>
                </form>
